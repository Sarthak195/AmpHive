...
REM ---------------------------------------------------------------------
echo Starting the relay stack on amphive-relay...
gcloud compute ssh amphive-relay --zone=us-west1-a --command="cd ~/amphive-relay && sudo docker compose -f docker-compose.relay.yml up -d"
pause
