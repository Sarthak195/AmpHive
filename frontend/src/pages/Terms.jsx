/**
 * Terms — public "Charging Credit Terms" page (/terms, no auth required).
 * =======================================================================
 * The load-bearing closed-loop declaration: AmpHive charging credit is a
 * prepaid instrument redeemable ONLY for EV charging on AmpHive — not a
 * wallet, not withdrawable as cash, not transferable. This framing (modelled
 * on how licensed EV networks present their charging wallets) is what keeps
 * the credit inside the RBI closed-system PPI exemption rather than reading as
 * a general "wallet service". Linked from the Marketing footer and the
 * Charging Credit page.
 */
      ...
      <div className="stack">
        ...
        <section className="card">
          ...
          <p className="text-3 text-sm">
            Questions about charging credit? Contact AmpHive support.
          </p>
        </section>
      </div>
    </main>
