  ...
  return (
    <CpoLayout>
      ...
      {loading ? (
        ...
        <>
          {/* Tabs owns the role="tabpanel" wrapper, so the editor body is its
              child rather than a sibling; the old wrapper div only carried
              .pricing-mode-tabs' bottom margin, which now rides the tablist. */}
          <Tabs
            tabs={[
