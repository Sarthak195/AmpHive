...
# ===========================================================================
# CPO Session Dispute / Refund Endpoints (coins-only — see
# database/models.py SessionDispute and MARKET_GAP_ANALYSIS.md §3
# "Refunds". Driver-side filing lives in backend/routers/sessions.py:
